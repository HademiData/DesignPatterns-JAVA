...
class Mediator {
    ...
    // reduce chaotic dependencies between objects. The pattern restricts
...
cooperate with the help of a mediator but don’t depend on each other.
     */
     ...
     /*
      *  The most popular usage of the Mediator pattern in 
      Java code is facilitating communications between GUI
       components of an app. The synonym of the Mediator is 
       the Controller part of MVC pattern.
      */
